...
#adjustments
adjustments <- function(n, exp_loss_followup_pct = 0, exp_dropout_pct = 0, exp_dropin_pct = 0, unequal_groups = FALSE, unequal_q1 = 0.5, unequal_q2 = 0.5) {
...
n_diffmeans <- function(expect_diff = NA, sd_diff = NA, mu0 = NA, mu1 = NA,  sd0 = NA, sd1 = NA,  n0 = NA, n1 = NA, 
            ...
            exp_loss_followup_pct = 0, exp_dropout_pct = 0, exp_dropin_pct = 0, unequal_groups = FALSE, unequal_q1 = 0.5, unequal_q2 = 0.5) {
 ...
 #adjustments
 n = adjustments(n = n, exp_loss_followup_pct = exp_loss_followup_pct, exp_dropout_pct = exp_dropout_pct, exp_dropin_pct = exp_dropin_pct, unequal_groups = unequal_groups, unequal_q1 = unequal_q1, unequal_q2 = unequal_q2)
