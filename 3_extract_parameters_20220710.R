...
for (k in 1:N){
 ...
 # extract sample size, AGB: include `n = `; look for 'per group'
 keywords = 'sample size'
 link_phrases = c('of', 'set at', 'set to', 'equal to', '.?= .?', 'greater than', 'greater than or equal to', '.?>.?', '.?>= .?')
 ...
 sample.size = find_num_assoc_with_word(
  ...
  breaking_words = c(significance, 'alpha', type_1,'power', 'beta', type_2, 'confidence', ' and ', ' with ', 'that', 'which'),
 ...
 #extract power
 keywords = 'power'
 link_phrases = c('of', '\\(1-beta\\) of', 'set at', 'at', 'set to', 'equal to', '.?= .?', 'greater than' , 'greater than or equal to', '.?>.?', '.?>= .?')
 phrases = c(keywords, paste0('power ', link_phrases))
 phrases_position = c('either', 'after', rep('before', 10))
 power.vec = find_num_assoc_with_word(
  sentences,
  phrases = phrases,
  keywords = keywords,
  phrases_position = phrases_position,
  breaking_words = c(significance, 'alpha', type_1, 'confidence', ' and ', ' with ', 'that', 'which'),
 ...
 keywords = c('beta', type_2)
 link_phrases = c('of', 'set at', 'at', 'set to', 'equal to', '.?= .?', 'less than' , 'less than or equal to', '.?<.?', '.?<= .?')
 phrases = c(keywords, 
       paste('beta', link_phrases),
 ...
 keywords = c(significance, 'alpha', type_1)
 link_phrases = c('of', 'set at', 'at', 'set to', 'equal to', '.?= .?', 'less than' , 'less than or equal to', '.?<.?', '.?<= .?')
 phrases = c('p.?= .?', 'p.?<.?', ' a.?= .?', significance, 'significan(t|ce).level', 'alpha', type_1_error, 
       paste(significance, link_phrases), 
       paste('significan(t|ce).level', link_phrases), 
       paste('alpha', link_phrases), 
 ...
 siglev.vec = find_num_assoc_with_word(
  ...
  keywords = keywords, 
  phrases_position = phrases_position, 
  breaking_words = c('power', 'beta', type_2, ' and ', ' with ', 'that', 'which',
            'mean', 'standard deviation', 'sd', 'coefficient', 'regression', 'detect'), 
  number_integer_general = FALSE, number_integer_percent = TRUE, 
  number_decimal_general = TRUE, number_decimal_percent = TRUE, 
  number_type = "probability", number_likely_limits = c(0, 0.5))
 ...
 link_phrases = c('of', 'set at', 'set to', 'equal to', '.?= .?')
 ...
 link_phrases = c('was', 'is', 'of', 'equal to', '.?= .?')
 ...
 link_phrases = c('is', 'was', 'of', 'equal to', '.?= .?')
